...
class UserFixture(BaseModel):
    ...
    @property
    def authentication_user(self) -> AuthenticationUserSchema: # Быстрый доступ к email и password пользователя
...
@pytest.fixture
def private_users_client(function_user) -> PrivateUsersClient: # Используем фикстуру function_user для получения данных аутентификации
