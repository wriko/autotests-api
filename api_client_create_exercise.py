...
create_course_request = CreateCourseRequestSchema(
    ...
    max_score = 100,
    min_score = 10,
    description = "Python API Course",ыеф
...
# Создаем задание
create_exercise_request = CreateExerciseRequestSchema( # Создаем объект CreateExerciseRequestDict с необходимыми данными для создания задания
    title = "Exercise 1",
    course_id = create_course_response.course.id, # Идентификатор курса, в котором будет создано задание
    max_score = 5,
    min_score = 1,
    order_index = 0,
